...
>
> **Last meaningful overhaul:** 2026-05-29 (PM) — Spec 9l v0.3 patch landed (0032 trigger + 3 locked adapter MDs + calibration triad theses seeded). Earlier the same day: v0.2 patch + Spec 9l Phase 1 baseline shipped (0031 migration + 8-adapter Repository view + tab rename).
