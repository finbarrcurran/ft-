...
>
> **Last meaningful overhaul:** 2026-05-30 — Spec 9l v0.4 patch + Phase 1 ship gate (8/10 acceptance criteria green; D25 Scoring Engine modal + cron framework deferred to Phase 2). Cascade engine, cross-thesis table, per-thesis detail, Allocation Panel UI, 9e sell-window verdict badge all live. Earlier (2026-05-29 PM): v0.3 patch with 0032 trigger + 3 adapter MDs + calibration triad theses.
